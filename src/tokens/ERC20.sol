...
/**
 * @title ERC20 Token Router that extends ERC20 with remote transfer functionality.
 * @author Abacus Works
...
contract HypERC20 is ERC20Upgradeable, TokenRouter {
    ...
    /**
     * @notice Initializes the Token router, ERC20 metadata, and mints initial supply to deployer.
