...
/**
 * @title ERC721 Token Router that extends ERC721 with remote transfer functionality.
 * @author Abacus Works
 */
contract HypERC721 is ERC721EnumerableUpgradeable, TokenRouter {
    ...
    /**
     * @notice Initializes the Token router, ERC721 metadata, and mints initial supply to deployer.
